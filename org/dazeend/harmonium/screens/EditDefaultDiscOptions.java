 ...
 *
 */
public class EditDefaultDiscOptions extends HScreen {
	 ...
	 * @param title
	 */
	public EditDefaultDiscOptions(Harmonium app) {
		super(app, "Disc Options");
		...
		if(this.app.getPreferences().getDiscDefaultRepeatMode()) {
		...
		if(this.app.getPreferences().getDiscDefaultShuffleMode()) {
		...
		if(this.app.getPreferences().getDiscTrackSortMode().equals(ApplicationPreferences.SORT_TRACKS_BY_NUMBER)) {
		...
		else if(this.app.getPreferences().getDiscTrackSortMode().equals(ApplicationPreferences.SORT_TRACKS_BY_NAME)) {
	...
	public boolean handleKeyPress(int code, long rawcode) {
		...
		if(this.getFocus() != null && this.getFocus().equals(this.OKButton) && code == KEY_SELECT) {
			...
			// set Preferences
			this.app.getPreferences().setDiscDefaultRepeatMode(repeatMode);
			this.app.getPreferences().setDiscDefaultShuffleMode(shuffleMode);
			this.app.getPreferences().setDiscTrackSort(sortMode);
