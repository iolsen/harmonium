 ...
 *
 */
public class EditDefaultPlaylistFileOptions extends HScreen {
	 ...
	 * @param title
	 */
	public EditDefaultPlaylistFileOptions(Harmonium app) {
		super(app, "Default Playlist Options");	
		...
		if(this.app.getPreferences().getPlaylistFileDefaultShuffleMode()) {
	...
	public boolean handleKeyPress(int code, long rawcode) {
		...
		if(this.getFocus() != null && this.getFocus().equals(this.OKButton) && code == KEY_SELECT) {
			...
			// set Preferences
			this.app.getPreferences().setPlaylistFileDefaultRepeatMode(repeatMode);
			this.app.getPreferences().setPlaylistFileDefaultShuffleMode(shuffleMode);
